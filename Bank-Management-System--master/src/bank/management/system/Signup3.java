        ...
        try {
            if (e.getSource() == s) {
                if (atype.equals("")) {
                    ...
                    Connn c1 = new Connn();
                    PreparedStatement pst1 = c1.prepareStatement("INSERT INTO signupthree(formno,account_type,card_number,pin,services) VALUES(?,?,?,?,?)");
                    pst1.setString(1, formno);
                    pst1.setString(2, atype);
                    pst1.setString(3, cardno);
                    pst1.setString(4, pin);
                    pst1.setString(5, fac);
                    pst1.executeUpdate();

                    PreparedStatement pst2 = c1.prepareStatement("INSERT INTO login(card_number,pin) VALUES(?,?)");
