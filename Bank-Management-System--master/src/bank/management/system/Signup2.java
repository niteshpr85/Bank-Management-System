    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            if (textPan.getText().equals("") || textAadhar.getText().equals("")) {
                ...
                Connn c = new Connn();
                PreparedStatement pst = c.prepareStatement("INSERT INTO Signuptwo(formno,religion,category,income,education,occupation,pan,aadhar,senior_citizen,existing_account) VALUES(?,?,?,?,?,?,?,?,?,?)");
