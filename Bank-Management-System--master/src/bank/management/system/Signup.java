...
public class Signup extends JFrame implements ActionListener {
    ...
    JTextField textName, textFname, textEmail, textAdd, textcity, textState, textPin, dateChooser;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            if (textName.getText().equals("")) {
                ...
                Connn c = new Connn();
                PreparedStatement pst = c.prepareStatement("INSERT INTO signup(formno,name,fname,dob,gender,email,marital,address,city,pincode,state) VALUES(?,?,?,?,?,?,?,?,?,?,?)");
